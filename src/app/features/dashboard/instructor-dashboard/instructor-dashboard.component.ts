        ...
        <div class="grid lg:grid-cols-12 gap-10">
          ...
          <div class="lg:col-span-8 space-y-8">
            <div class="flex items-center justify-between mb-2">
               ...
               <button class="text-[#0D9488] font-bold text-sm hover:underline">View All Courses</button>
            </div>
              ...
              @for (course of courses; track course.id) {
                <div class="bg-white rounded-[24px] p-6 border border-gray-100 shadow-sm hover:shadow-md hover:border-teal-100 transition-all group overflow-hidden">
                  <div class="flex flex-col sm:flex-row items-center gap-6">
                    <img [src]="course.image" [alt]="course.title" class="w-24 h-24 rounded-2xl object-cover shadow-sm group-hover:scale-105 transition-transform" />
