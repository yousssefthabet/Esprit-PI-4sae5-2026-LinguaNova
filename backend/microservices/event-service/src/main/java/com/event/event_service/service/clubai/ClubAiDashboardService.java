package com.event.event_service.service.clubai;

import com.event.event_service.dto.clubai.ClubActivityFeedItemDto;
import com.event.event_service.dto.clubai.ClubDashboardResponseDto;
import com.event.event_service.dto.clubai.ClubEngagementResponseDto;
import com.event.event_service.dto.clubai.ClubHealthMetricsDto;
import com.event.event_service.dto.clubai.ClubRecommendationDto;
import com.event.event_service.dto.clubai.ClubSessionAnalysisResponseDto;
import com.event.event_service.dto.clubai.GenerateClubActivityRequestDto;
import com.event.event_service.dto.clubai.GeneratedClubActivityResponseDto;
import com.event.event_service.dto.clubai.ParticipationTrendPointDto;
import com.event.event_service.dto.clubai.RecommendationActionHistoryDto;
import com.event.event_service.dto.clubai.RecommendationStatusUpdateRequestDto;
import com.event.event_service.dto.clubai.StudentClubInsightResponseDto;
...
import com.event.event_service.repository.AiRecommendationActionHistoryRepository;
import com.event.event_service.repository.AiRecommendationRepository;
import com.event.event_service.repository.ClubActivityRepository;
import com.event.event_service.repository.ClubMemberRepository;
import com.event.event_service.repository.ClubRepository;
import com.event.event_service.repository.ClubSessionRepository;
import com.event.event_service.repository.EngagementScoreRepository;
