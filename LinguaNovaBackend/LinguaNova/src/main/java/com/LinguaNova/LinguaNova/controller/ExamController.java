...
import com.LinguaNova.LinguaNova.service.ExamService;
...
public class ExamController {
    ...
    public ResponseEntity<Exam> getExamById(
            @Parameter(description = "ID de l'examen") @PathVariable("id") Long id) {
    ...
    public ResponseEntity<List<Exam>> searchExamsByTitle(
            @Parameter(description = "Texte à rechercher dans le titre") @RequestParam("title") String title) {
    ...
    public ResponseEntity<List<Exam>> getExamsByStatus(@PathVariable("status") ExamStatus status) {
    ...
    public ResponseEntity<List<Exam>> getExamsByCourseName(@PathVariable("courseName") String courseName) {
    ...
    public ResponseEntity<List<Exam>> getExamsByCourseAndStatus(
            ...
            @PathVariable("status") ExamStatus status) {
    ...
    public ResponseEntity<Exam> publishExam(@PathVariable("id") Long id) {
        try {
    ...
    public ResponseEntity<Exam> closeExam(@PathVariable("id") Long id) {
        try {
