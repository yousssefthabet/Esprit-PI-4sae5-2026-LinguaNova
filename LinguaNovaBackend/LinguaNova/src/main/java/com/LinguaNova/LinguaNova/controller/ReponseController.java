...
import com.LinguaNova.LinguaNova.service.ReponseService;
...
public class ReponseController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Reponse> updateReponse(@PathVariable("id") Long id, @Valid @RequestBody Reponse reponse) {
        try {
    ...
    public ResponseEntity<List<Reponse>> getCorrectReponsesByQuestionId(@PathVariable("questionId") Long questionId) {
